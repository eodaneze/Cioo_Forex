...
<body>
    ...
    <section id="hero" class="d-flex align-items-center"
        style="background: linear-gradient(rgba(250,127,72, 0.7), rgba(251,106,83, 0.5)), url('./assets/img/hero.jpg') center/cover fixed no-repeat; height: 100vh;">

        <!-- <div class="container">
            <div class="row">
                <div class="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1"
                    data-aos="fade-up" data-aos-delay="200">
                    <h1>Cioo Forex Trading Academy</h1>
                    <h2>With Sniper Entry Trading Strategy, forever stuck in profit.</h2>
                    <div class="d-flex justify-content-center justify-content-lg-start main">
                        <a href="#about" class="btn-get-started">Mentorship</a>
                        <a href="#about" class="btn-get-started">Signals</a>
                        ...
                        <form action="./includes/contact.php" method="post">
                            ...
                            <div class="row mb-3">
                                <div class="col-lg-12">
                                    ...
                                    <input type="text" name="subject" class="form-control w-100">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-lg-12">
                            ...
                            <div class="text-center">
                                <button class="btn" style="background-color: #47B2E4; color: white; padding: 8px 20px;"
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-6">
                        ...
                        <p>Enter Your Email to get latest update from CiooForex</p>
                        <form action="./includes/newsLetter.php" method="post">
                            <input type="email" name="email" style="outline:none"><input type="submit" name="submit"
                                value="Subscribe">
                        </form>
                    </div>
                </div>
